...
app.post("/konversi_panjang", (req, res) => {
...
app.get("/haha/:gaya/:mas/:per", (req, res) => {
    let gaya = mas*per(req.params.gaya);
    let mas = gaya/per (req.params.massa);
    let per = gaya/mas(req.params.percepatan);
